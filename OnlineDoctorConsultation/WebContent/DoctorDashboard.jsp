  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="#" style="color: rgb(250, 246, 246); font-family: 'Reggae One', cursive; font-size: 16px">Contact : #080-522301</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="DoctorLogin.html"  style="color: rgb(253, 249, 249); font-family: 'Reggae One', cursive; font-size: 16px"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
    ...
    <div class="col-sm-2 sidenav"  style="background-color:rgb(164, 224, 252)">
        <div class="list-group rounded-0">
            <a href="#" class="list-group-item list-group-item-action active border-0 d-flex align-items-center">
              <span class="ml-2" style="color: rgb(253, 253, 253); font-family: 'Reggae One', cursive; font-size: 15px;">Doctor Dashboard</span>
            </a>
            <a href="DoctorDetails.jsp" class="list-group-item list-group-item-action border-0 align-items-center">
             <span class="ml-2"><b>My Profile</b></span>
            </a>
            <a href="ViewPatients.jsp" class="list-group-item list-group-item-action border-0 align-items-center">
              <span class="ml-2"><b>View Appointments</b></span>
            </a>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="panel panel-white no-radius text-center">
            ...
            <h2 class="StepTitle" style="font-family: 'Parisienne', cursive;"><b>View Appointments</b></h2>
